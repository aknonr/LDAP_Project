...
/// <summary>
/// IIS site icin apppool identity hedef hesapla eslesiyorsa sifreyi gunceller.
/// </summary>
public sealed class IisSiteUpdateStrategy : RemoteJsonUpdateStrategyBase
{
    public IisSiteUpdateStrategy(
        IRemoteCommandExecutor remoteCommandExecutor,
        ILogger<IisSiteUpdateStrategy> logger)
    ...
    protected override string BuildScript(Domain.Entities.JobResource resource, string targetAccount, string newPassword)
    {
        ...
        {
            return """
[PSCustomObject]@{ state = 'FAILED'; code = 'RESOURCE_NOT_FOUND'; message = 'IIS site apppool bilgisi bulunamadi.' } | ConvertTo-Json -Compress
""";
        }
...
try {
    ...
    [PSCustomObject]@{ state = 'UPDATED'; code = 'OK'; message = 'IIS site apppool credentials guncellendi.' } | ConvertTo-Json -Compress
}
catch {
