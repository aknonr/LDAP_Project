...
/// <summary>
/// IIS AppPool identity specific-user ise ve hedef hesapla eslesiyorsa sifreyi gunceller.
/// </summary>
public sealed class IisAppPoolUpdateStrategy : RemoteJsonUpdateStrategyBase
{
    public IisAppPoolUpdateStrategy(
        IRemoteCommandExecutor remoteCommandExecutor,
        ILogger<IisAppPoolUpdateStrategy> logger)
    ...
    {
        var appPoolNameBase64 = ToBase64(resource.ResourceName);
...
try {
    ...
    [PSCustomObject]@{ state = 'UPDATED'; code = 'OK'; message = 'IIS AppPool credentials guncellendi.' } | ConvertTo-Json -Compress
}
catch {
